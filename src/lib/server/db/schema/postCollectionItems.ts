import { pgTable, integer, text, uniqueIndex, index, primaryKey, check } from 'drizzle-orm/pg-core';
...
// Export types
export type PostCollectionItemOrm = typeof postCollectionItems.$inferSelect;
